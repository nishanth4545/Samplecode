...
public class WeatherApiTest {
	...
	private String baseURI = "http://api.openweathermap.org/api";
	...
	public void the_Response_code_is_succesfull() throws Throwable {
		Response response = given().when().get("/data/2.5/weather?zip=94040,us&appid=651587654bcd0392c12915b211ad8efa");
		System.out.println("response: " + response.then().statusCode(200));
	}
	...
	public void the_Response_is_in_JSON_format() throws Throwable {
		response =given().params("zip", "94040,us", "appid", "651587654bcd0392c12915b211ad8efa").when().
		get("/data/2.5/weather");
		System.out.println(response.then().contentType("application/json"));
